...
<!-- END: Brand -->			
	...
	@include('layouts.metronichorizontalmenu')
												<!-- BEGIN: Topbar -->
...
<!-- END: Header -->		
	...
	@include('layouts.metronicleftnav')	
...
<!-- end::Scroll Top -->		    
	@include('layouts.metronicquicknav')
    <!-- @include ('layouts.metronicnav') -->

    <div class="container">
		@yield('content')
	</div>

	@include('layouts.metronicfooter')  
